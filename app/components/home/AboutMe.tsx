    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-col gap-3">
        ...
        <a
          ...
          target="_blank"
          className="bg-resumepurple text-resumewhite dark:bg-resumewhite dark:text-resumepurple px-2 py-1 mt-2 hover:opacity-90 transition duration-300 w-fit rounded-md text-sm tracking-tight">
